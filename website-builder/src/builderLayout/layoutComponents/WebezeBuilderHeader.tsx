    ...
    <Fragment>
      <div className="relative z-[2] flex h-20 items-center gap-1 xl:gap-3 2xl:gap-5 px-2 py-3 bg-white dark:bg-muted-800">
        ...
        <div className="flex items-center gap-x-1">
          <button className={`rounded-xl p-2 ${selectedViewDeviceSize === "desktop" ? "bg-primary-100 text-primary-500" : "text-gray-400 hover:bg-gray-100"}`}
            data-webeze-tooltip-position="down"
            data-webeze-tooltip={`Desktop/Laptop`}
            onClick={() => setSelectedViewDeviceSize("desktop")}
          >
            <Icon
          ...
          <button className={`rounded-xl p-2 ${selectedViewDeviceSize === "tablet" ? "bg-primary-100 text-primary-500" : "text-gray-400 hover:bg-gray-100"}`}
            data-webeze-tooltip-position="down"
            onClick={() => setSelectedViewDeviceSize("tablet")}
          >
            <Icon icon={"uil:tablet"} className="h-5 w-5 stroke-current" />
          </button>
          <button className={`rounded-xl p-2 ${selectedViewDeviceSize === "mobile" ? "bg-primary-100 text-primary-500" : "text-gray-400 hover:bg-gray-100"}`}
            data-webeze-tooltip-position="down"
            data-webeze-tooltip={`Mobile`}
            onClick={() => setSelectedViewDeviceSize("mobile")}
          >
