            ...
            <div className="relative z-[1] flex h-16 items-center gap-1 xl:gap-3 2xl:gap-5 mx-8">
                ...
                <button className="flex flex-col items-start rounded-xl border border-gray-200 bg-gray-100 px-6 py-2 dark:bg-muted-800 dark:border-muted-700">
                    <div className="flex items-center gap-x-2">
                        ...
                        <Icon icon={"lucide:chevron-down"} className="h-5 w-5 stroke-current text-gray-400" />
                    </div>
                ...
                <button className="flex items-center justify-center gap-x-2 rounded-xl bg-gray-100 px-4 py-2 dark:bg-muted-700">
                    <Icon icon={"solar:eye-broken"} className="h-5 w-5 stroke-current text-gray-400" />
                ...
                <div className="flex items-center gap-x-1">
                    <button className="rounded-xl bg-indigo-100 p-2 text-blue-600">
                        <Icon icon={"solar:laptop-broken"} className="h-5 w-5 stroke-current" />
                    </button>
                    ...
                    <button className="rounded-xl p-2 text-gray-400 hover:bg-gray-100">
                        <Icon icon={"tabler:device-mobile-rotated"} className="h-5 w-5 stroke-current" />
                    </button>
                </div>
                {/* DIVIDER */}
                <div className="h-full w-px bg-gray-200" />
                <button className="flex items-center justify-center gap-x-2 rounded-xl bg-gray-100 px-4 py-2 dark:bg-muted-700">
                    ...
                    <Icon icon={"tdesign:chevron-down"} className="h-5 w-5 stroke-current text-gray-400" />
                </button>

                <button className="flex items-center justify-center rounded-xl bg-gray-100 p-2 dark:bg-muted-700">
                    <Icon icon={"bxs:package"} className="h-5 w-5 stroke-current text-gray-400" />
                </button>
                <div className="ms-auto" />
                <div className="flex items-center gap-2 h-16">
                    <div className="flex h-18 items-center gap-x-4 px-6">
                        <button className="flex items-center justify-center gap-x-2 rounded-xl bg-gray-100 px-4 py-2 dark:bg-muted-700">
                            <Icon icon={"material-symbols:draft-orders-outline-sharp"} className="h-5 w-5 stroke-current text-gray-400" />
