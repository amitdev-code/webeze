  ...
  return (
    <Combobox
      ...
      className={cn(
        ...
        props.labelFloat && "webeze-autocomplete-label-float",
      ...
      >
        <>
          {label && !props.labelFloat && (
            <Combobox.Label
              className={cn("webeze-autocomplete-label", classes?.label)}
            >
          ...
          {multiple && (
            <div className="webeze-autocomplete-multiple">
              {Array.isArray(autocompleteValue) &&
                autocompleteValue.length > 0 && (
                  <ul className="webeze-autocomplete-multiple-list">
                    {autocompleteValue.map((item) => (
                      <li key={String(item)}>
                        {props.renderAutocompleteMultipleListItem?.({
                          ...
                          <div className="webeze-autocomplete-multiple-list-item">
                            ...
                            >
                              <Icon
                                icon={chipClearIcon}
                                className="webeze-autocomplete-multiple-list-item-icon"
                              />
                            </button>
                          </div>
                        )}
        ...
        <Float.Reference>
          <div className="webeze-autocomplete-outer">
            <Combobox.Input
              className={cn(
            ...
            {iconResolved && (
              <div className="webeze-autocomplete-icon">
                {props.renderIcon?.({ iconName: iconResolved }) || (
                  <Icon
                    icon={iconResolved}
                    className="webeze-autocomplete-icon-inner"
                  />
                )}
              </div>
            )}
              ...
              ((Array.isArray(autocompleteValue) &&
                ...
                >
                  {props.renderClearIcon?.() || (
                    <Icon
                      icon={clearIcon}
                      className="webeze-autocomplete-clear-inner"
                    />
                  )}
                </button>
              )}
            ...
            {dropdown && (
              <Combobox.Button className="webeze-autocomplete-clear webeze-autocomplete-chevron">
                {({ open }) => (
                  <>
            ...
            {loading && (
              <div className="webeze-autocomplete-placeload">
                <BasePlaceload
                  className={cn(
                    "webeze-placeload",
        ...
        <Float.Content className={cn(!fixed && "w-full")}>
          ...
          >
            {filteredItems.length === 0 && pending ? (
              <div className="webeze-autocomplete-results-placeholder">
                {props.renderPending?.({
                  query,
                  filteredItems,
                  pending,
                  ...
                  <span className="webeze-autocomplete-results-placeholder-text text-sm">
                    {i18n.pending}
                  </span>
                )}
              </div>
              ...
              <>
                {props.renderStartItem && (
                  <div className="webeze-autocomplete-results-header">
                    {props.renderStartItem({
                      query,
                      filteredItems,
                      pending,
                    ...
                    {({ active, selected }) => (
                      <>
                        {props.renderCreateItem?.({
                          ...
                          <span className="webeze-autocomplete-results-item">
                            Create {query}
                          </span>
                        )}
                      </>
                ...
                {filteredItems.map((item) => (
                  <Combobox.Option
                    key={key(item)}
                    as="div"
                    className="webeze-autocomplete-results-item"
                    value={
                      props.stateModifiers?.prop && props.properties?.value
                ...
                {props.renderEndItem && (
                  <div className="webeze-autocomplete-results-footer">
                    {props.renderEndItem({
                      query,
                      filteredItems,
                      pending,
