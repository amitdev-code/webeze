...
export default plugin(({ addComponents, theme }) => {
  const config = theme(`webeze.${key}`) satisfies ListboxConfig
  ...
  addComponents({
    ...
    '.webeze-listbox': {
      ...
      //Listbox:label
      '.webeze-listbox-label, .webeze-label-float': {
        '@apply webeze-label': {},
      },
      //Label:float
      '.webeze-label-float': {
      ...
      //Listbox:outer
      '.webeze-listbox-outer': {
        '@apply relative': {},
      },
      //Listbox:button
      '.webeze-listbox-button': {
        //Base
        [`@apply webeze-focus relative w-${config.button.size} flex items-center gap-2 pe-12 ps-4 border leading-5 disabled:cursor-not-allowed disabled:opacity-75`]:
          {},
        //Font
        [`@apply font-${config.button.font.family} text-${config.button.font.size} text-${config.button.font.align}`]:
          {},
        //Button:inner
        '.webeze-listbox-button-inner': {
        ...
        //Inner:chevron
        '&:focus-visible ~ .webeze-listbox-chevron .webeze-listbox-chevron-inner, &:focus ~ .webeze-listbox-chevron .webeze-listbox-chevron-inner':
          {
            '@apply !rotate-180': {},
          },
      },
      //Listbox:icon
      '.webeze-listbox-icon.webeze-icon': {
        //Color
      ...
      //Listbox:chevron
      '.webeze-listbox-chevron.webeze-chevron': {
        //Base
      ...
      //Listbox:options
      '.webeze-listbox-options': {
        [`@apply webeze-slimscroll absolute z-10 mt-1 max-h-60 w-full overflow-auto p-${config.options.padding}`]:
          {},
        //Font
      ...
      //Rounded:sm
      '&.webeze-listbox-rounded-sm': {
        '.webeze-listbox-button, .webeze-listbox-options, .webeze-listbox-option': {
          [`@apply ${config.rounded.sm}`]: {},
        },
      },
      //Rounded:md
      '&.webeze-listbox-rounded-md': {
        '.webeze-listbox-button, .webeze-listbox-options, .webeze-listbox-option': {
          [`@apply ${config.rounded.md}`]: {},
        },
      },
      //Rounded:lg
      '&.webeze-listbox-rounded-lg': {
        '.webeze-listbox-button, .webeze-listbox-options, .webeze-listbox-option': {
          [`@apply ${config.rounded.lg}`]: {},
        },
      },
      //Rounded:full
      '&.webeze-listbox-rounded-full': {
        '.webeze-listbox-button': {
          [`@apply ${config.rounded.full}`]: {},
        },

        '.webeze-listbox-option, .webeze-listbox-options': {
          [`@apply ${config.rounded.lg}`]: {},
        },
      },
      //Color:default
      '&.webeze-listbox-default': {
        '.webeze-listbox-button': {
          //Color
      ...
      '&.webeze-listbox-default-contrast': {
        '.webeze-listbox-button': {
          //Color
      ...
      //Listbox:loaded
      '&:not(.webeze-listbox-loading)': {
        '.webeze-listbox-button ~ .webeze-label-float': {
          [`@apply text-${config.loaded.font.color.light} dark:text-${config.loaded.font.color.dark}`]:
            {},
        },
      },
      //Listbox:loading
      '&.webeze-listbox-loading': {
        '.webeze-listbox-button': {
      ...
      '&:not(.webeze-has-icon).webeze-listbox-sm': {
        '.webeze-listbox-button': {
      ...
      //With:icon && Size:sm
      '&.webeze-has-icon.webeze-listbox-sm': {
        '.webeze-listbox-button': {
      ...
      '&:not(.webeze-has-icon).webeze-listbox-md': {
        '.webeze-listbox-button': {
      ...
      //With:icon && Size:md
      '&.webeze-has-icon.webeze-listbox-md': {
        '.webeze-listbox-button': {
      ...
      '&:not(.webeze-has-icon).webeze-listbox-lg': {
        '.webeze-listbox-button': {
      ...
      //With:icon && Size:lg
      '&.webeze-has-icon.webeze-listbox-lg': {
        '.webeze-listbox-button': {
      ...
      '&:not(.webeze-has-icon).webeze-listbox-xl': {
        '.webeze-listbox-button': {
      ...
      //With:icon && Size:xl
      '&.webeze-has-icon.webeze-listbox-xl': {
        '.webeze-listbox-button': {
      ...
      '&.webeze-listbox-label-float:not(.webeze-has-icon).webeze-listbox-sm': {
        '.webeze-label-float': {
          [`@apply start-3 -ms-3 -mt-7 text-${config.icon.disabled.label.float.sm.font.size} text-transparent`]:
            {},
        },
        '.webeze-listbox-button:focus-visible ~ .webeze-label-float, .webeze-listbox-button:focus ~ .webeze-label-float, .webeze-label-float-active':
          {
      ...
      '&.webeze-listbox-label-float.webeze-has-icon.webeze-listbox-sm': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float:not(.webeze-has-icon).webeze-listbox-md': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float.webeze-has-icon.webeze-listbox-md': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float:not(.webeze-has-icon).webeze-listbox-lg': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float.webeze-has-icon.webeze-listbox-lg': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float:not(.webeze-has-icon).webeze-listbox-xl': {
        '.webeze-label-float': {
      ...
      '&.webeze-listbox-label-float.webeze-has-icon.webeze-listbox-xl': {
        '.webeze-label-float': {
