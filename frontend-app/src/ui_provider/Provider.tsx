...
export const useWebezeDefaultProperty = <
...
>(
  ...
  if (config?.[component]?.[property] === undefined) {
    ...
    console.warn(
      `webeze Default configuration for ${component}.${String(
        property
      )} not found, did you forget to use <WebezeUIProvider>?`
    );
  }
...
export const useThemeContext = () => {
  ...
  if (!ctx) {
    throw new Error(
      "webeze useThemeContext() has no contex, did you forget to use <WebezeUIProvider>?"
    );
  }
...
export const WebezeUIProvider: FC<{
  children: ReactNode;
