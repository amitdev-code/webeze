...
import { BaseThemeToggle, BaseHeading, BaseParagraph, BaseMessage, BaseInput, BaseButton } from '../../../component';
  ...
  return (
    <div className="bg-muted-100 dark:bg-muted-900 relative min-h-screen w-full overflow-hidden px-4">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4">
        <Link to="/dashboards" className="text-muted-400 hover:text-primary-500 dark:text-muted-700 dark:hover:text-primary-500 transition-colors duration-300">
        ...
        <div className="relative mx-auto w-full max-w-2xl">
          <div className="me-auto ms-auto mt-4 w-full max-w-md">
            <div className="text-center">
              <BaseHeading as="h2" size="3xl" weight="medium">Recover Password</BaseHeading>
                ...
                <div className="mb-4 space-y-4">
                  <BaseMessage closable={false}>
                    ...
                    <small className="block pt-2">
                      If you don't receive an email, please check your spam folder. If you still don't receive an email, that means you don't have an account.
                    </small>
                  </BaseMessage>
                </div>
              </div>
            ) : (
              <form method="POST" onSubmit={handleSubmit(onSubmit)} className="px-8 py-4" noValidate>
                <div className="mb-4 space-y-4">
                  <Controller
                    name="email"
                    control={control}
