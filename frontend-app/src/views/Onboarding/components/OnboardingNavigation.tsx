  ...
  return (
    <Fragment>
      <div className="dark:bg-muted-800 absolute start-0 top-0 h-16 w-full bg-white">
            ...
            <div ref={targetRef} className="relative hidden sm:block">
              ...
              >
                <Icon
                  ...
                  className={`text-muted-400 size-4 transition-transform duration-300 ${
                    openDropdown ? "rotate-180" : ""
                  }`}
                />
              </button>
              <div
                className={`border-muted-200 dark:border-muted-700 dark:bg-muted-800 shadow-muted-300/30 dark:shadow-muted-900/30 absolute start-0 top-8 z-20 w-52 rounded-xl border bg-white p-2 shadow-xl transition-all duration-300 ${
                  openDropdown
                ...
                <div className="space-y-1">
                  {steps?.map((step, index) => (
                    ...
                    >
                      ...
                      <h4 className="text-muted-800 text-xs font-medium dark:text-white">
                        {step.title}
                      </h4>
                    </button>
                  ))}
        ...
        <OnboardingStepTitle steps={steps} currentStep={currentStep} />
        {children}
      </div>
    </Fragment>
  );
